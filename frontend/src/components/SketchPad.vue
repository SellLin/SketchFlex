      ...
      <el-col :span="16">
        <el-row> 
          <el-col :span="2" style="margin-left: -50px;">
            ...
            <!-- 添加最后一行 -->
            <div class="label-row" style="margin-left: 732px; margin-top: -80px; width: 120px; height: 40px; display: flex; align-items: center;">
              <!-- 加号按钮，替代色块按钮 -->
            ...
            <div id="palette" style="display:inline-block; width: 180px; height:310px;;margin-left: 730px;margin-top:-33px;background-color: white;">
              <div style="margin-top:35px;width: 300px;margin-left:-85px;">
                ...
                <el-form :model="formDataA">
                    <el-input v-model="formDataA.type" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 1, maxRows: 1}">
                    </el-input>
                </el-form>
                <p style="margin-left:10px;margin-top: 5px;user-select: none;">Attribute:</p>
                <el-form :model="formDataA">
                    <el-input v-model="formDataA.attr" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 1, maxRows: 1}">
                    </el-input>
                </el-form>
                ...
                <el-form :model="formDataA" >
                    <el-input v-model="formDataA.background" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 1, maxRows: 1}">
                    </el-input>
                </el-form>
              </div>
            </div>
          ...
          <el-col :span="2" style="margin-left: 120px;">
            <div id="palette" style="display:inline-block; width: 177px; height:310px;;margin-left: 730px;margin-top:0px;background-color: white;">
              <div style="margin-top:35px;width: 300px;margin-left:-85px;">
                ...
                <el-form :model="formDataA" >
                    <el-input v-model="formDataA.direction" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 1, maxRows: 1}">
                    </el-input>
                </el-form>
  
                <p style="margin-left:10px;margin-top: 5px;user-select: none;">Negative:</p>
                <el-form :model="formDataA" >
                    <el-input v-model="formDataA.neg" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 1, maxRows: 1}">
                    </el-input>
                </el-form>
