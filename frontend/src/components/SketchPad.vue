...
<!-- <div class="header2" style="display: flex; align-items: center; width: 95%; margin-left: 20px; width: 820px;">
    <p style="font-size: 18px; font-weight: bold; margin-left: 380px">Canvas</p>
</div> -->
  <!-- <el-row> 
    <el-col :span="2"></el-col>
      <div class="header2" style="width:90%;margin-left: 80%;">
      <p style="font-size: 18px;font-weight: bold;">Canvas</p>
      </div>
  </el-row>  -->
  <!-- <div class="header2" style="width:90%;margin-left: 80%;">
      <p style="font-size: 18px;font-weight: bold;">Canvas</p>
...
<el-row> 
    ...
    <el-col :span="2" style="margin-left: 20px">
      <div class="header2" style="width:700px;margin-left: -100px;">
                  <p style="font-size: 18px;font-weight: bold;">Canvas</p>
              </div>

      <div style="display:inline-block; width: 820px; height:800px; margin-left: -180px;margin-top: 10px; border: ridge 1px;">
    ...
    <el-col :span="16">
      <el-row> 
        <el-col :span="2" style="margin-left: -50px;">
          ...
          <div id="palette" style="display:inline-block; width: 190px; height:310px;margin-left: 717px;margin-top: 0px;background-color: white;">
            <br>
              <div class="label-row" v-for="(label, index) in labels" :key="index" style="margin-left: 15px;margin-top: 10px;width: 200px; height:40px;">
                <!-- Small color rectangle -->
                <div class="color-rect" :style="{ backgroundColor: label.color}" @click="changeColor"></div>
                <!-- Text entry -->
                <el-input v-model="label.text" placeholder="Enter text" style="width:90px"></el-input>
                </div>
          </div>
          <!-- 添加最后一行 -->
          <div class="label-row" style="margin-left: 732px; margin-top: -80px; width: 200px; height: 40px; display: flex; align-items: center;">
            <!-- 加号按钮，替代色块按钮 -->
            <button @click="addLabel" style="width: 20px; height: 20px; cursor: pointer; background-color: #EEEEEE;border-color: #b6d8f2; border: none; font-size: 20px;line-height: 20px; padding: 0;">
              +
            </button>
            <!-- 确认按钮，替代文本输入框 -->
            <el-button type="primary" @click="postSpaceJson()" style="width: 90px; margin-left: 10px; background-color: #EEEEEE;border-color: #b6d8f2;height: 32px; line-height: 32px; padding: 0;color: black;z-index: 999;">
              Confirm
            </el-button>
          </div>
          <div style="position: relative; top: 0; right: 0; height: 250px; width: 1px; margin-left: 870px;margin-top: -250px;  border-right: 2px dashed #d3d3d3;;z-index: 50;"></div>
        </el-col>
        
        <el-col :span="2" style="margin-left: 120px;">
          <div class="header2" style="width:400px;margin-left: 610px;z-index: 9998;">
                  <p style="font-size: 18px;font-weight: bold;">Prompt Recommend</p>
            </div>
          <div id="palette" style="display:inline-block; width: 180px; height:310px;;margin-left: 730px;margin-top:-33px;background-color: white;">
            <div style="margin-top:35px;width: 300px;margin-left:-85px;">
                      <p style="margin-left:10px;margin-top: 5px;user-select: none;">Type:</p>
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.type" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">
                          </el-input>

                      </el-form>
                      <p style="margin-left:10px;margin-top: 5px;user-select: none;">Attribute:</p>
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.attr" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">

                          </el-input>

                      </el-form>
                      <p style="margin-left:10px;margin-top: 5px;user-select: none;">State:</p>
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.state" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 1, maxRows: 1}">

                          </el-input>

                      </el-form>
                      <!-- <p style="margin-left:10px;margin-top: 5px;user-select: none;">Direction:</p>
                      <el-form :model="formDataA" >
                          <el-input v-model="formDataA.direction" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">
                          </el-input>
                      </el-form> -->

                      <!-- <p style="margin-left:10px;margin-top: 5px;user-select: none;">Background:</p>
                      <el-form :model="formDataA" >
                          <el-input v-model="formDataA.background" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">

                          </el-input>

                      </el-form>

                      <p style="margin-left:10px;margin-top: 5px;user-select: none;">Background Attribute:</p>
                      <el-form :model="formDataA" >
                          <el-input v-model="formDataA.backgroundAttr" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">
                          </el-input>
                      </el-form> -->

                      <!-- <p style="margin-left:10px;user-select: none;">Negative:</p>
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.neg" placeholder="Please enter"  spellcheck="false" type="textarea" style="width:160px;margin-left: 5px;" :autosize="{ minRows: 1, maxRows: 1}">
                      ...
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.relation" placeholder="Please enter"  spellcheck="false" type="textarea" style="width:160px;margin-left: 5px;" :autosize="{ minRows: 2, maxRows: 2}">
                          </el-input>
                      </el-form>
        ...
        <el-col :span="2" style="margin-left: 120px;">
          <div id="palette" style="display:inline-block; width: 177px; height:310px;;margin-left: 730px;margin-top:0px;background-color: white;">
            <div style="margin-top:35px;width: 300px;margin-left:-85px;">
                      <!-- <p style="margin-left:10px;margin-top: 5px;user-select: none;">Type:</p>
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.type" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">
                      ...
                      <p style="margin-left:10px;margin-top: 5px;user-select: none;">State:</p>
                      <el-form :model="formDataA">
                          <el-input v-model="formDataA.state" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">
                      ...
                      <p style="margin-left:10px;margin-top: 5px;user-select: none;">Negative:</p>
                      <el-form :model="formDataA" >
                          <el-input v-model="formDataA.neg" placeholder="Please enter"  spellcheck="false" type="textarea" :style="inputStyle" :autosize="{ minRows: 2, maxRows: 2}">
                          </el-input>
                      </el-form>
                      ...
                      <div style="display: flex; align-items: flex-start;margin-left:80px;margin-top: 6px; margin-bottom: 3px;">
                          <p style="margin-left:10px;user-select: none;">Relationship:</p>
                          <select v-model="relationTargetOption" :class="selectClass" style="width:25px; margin-left:10px; height:25px; font-size:12px;">
                            <option disabled value="">Select a target</option>
                            <option v-for="item in labels" :key="item.value" :value="item.value" :style="{ backgroundColor: item.color, color: item.color }">
                              <span>{{ item.text }}</span> 
                            </option>
                    ...
                    <el-form :model="formDataA" style="margin-left: 5px;">
                            <el-input
                              v-model="formDataA.relation"
...
export default {
  ...
  computed: {
    inputStyle() {
      return {
        borderColor: this.textColor, // 绑定颜色到文本
        width: '160px',
        marginLeft: '5px',
        marginTop: '5px'
      };
  ...
  methods: {
    postSpaceJson(){
            ...
            dataStore.background = this.formDataA.background
            dataStore.backgroundAttr = this.formDataA.backgroundAttr
            ...
            mask_prompt.background.type = dataStore.background
            mask_prompt.background.attribute = dataStore.backgroundAttr
            if (color2!='')
            {
    ...
    changeColor(event){
      ...
      dataStore.background = mask_prompt.background.type
      dataStore.backgroundAttr = mask_prompt.background.attribute
      if (color2!=''){
      ...
      this.updateData();
      postUpdateJson(mask_prompt, (res) => {
          // 替换简单字符串属性
          mask_prompt.style = res.style;
          mask_prompt.camera = res.camera;
          mask_prompt.quality = res.quality;
          mask_prompt.lighting = res.lighting;
          mask_prompt.environment = res.environment;

          // 替换 background 属性
          mask_prompt.background = {
              type: res.background.type,
              attribute: res.background.attribute,
              state: res.background.state,
              direction: res.background.direction,
              negative: res.background.negative
          };

          // 替换 red, green, blue, yellow 属性
          ['red', 'green', 'blue', 'yellow'].forEach(color => {
              mask_prompt[color] = {
                  type: res[color].type,
                  attribute: res[color].attribute,
                  state: res[color].state,
                  direction: res[color].direction,
                  negative: res[color].negative
              };
          });

          // 替换 relationships 属性
          ['red', 'green', 'blue', 'yellow'].forEach(color1 => {
              ['red', 'green', 'blue', 'yellow', 'background'].forEach(color2 => {
                  mask_prompt.relationships[color1][color2] = res.relationships[color1][color2];
              });
          });
      });
    ...
    updateData() {
          ...
          this.formDataA.background = dataStore.background;
          this.formDataA.backgroundAttr = dataStore.backgroundAttr;
          let color = this.textColor
          let color2 = this.relationTargetOption;
          if(color2 != ''){
            this.formDataA.relation = mask_prompt['relationships'][color][color2]
          }

          // this.formDataA.relation = dataStore.relationship;
        },
    // 橡皮擦，将画笔变成白色（背景颜色）
    clearSome() {
      // this.pen("#fff");
  ...
  watch: {
    ...
    relationTargetOption(newVal, oldVal){
      this.updateData()
      console.log('hey')
    },
    do_types: {
