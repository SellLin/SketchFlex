<template>
   ...
   <el-row>
       ...
       <el-col :span="8">
           <div id="TestPrompt" style="width:900px;height:940px;margin-left:0px;background-color: white;border-radius: 8px;margin-top:40px">
             ...
             <el-button @click="cleanPrompt()" style = "margin-top: 1%;margin-bottom: 5%; margin-left: 15%;">
                 Clean
             </el-button>
             <br>
         </div>
       ...
       <el-col :span="4" style="margin-left: 102px;margin-top:300px">
           <div id="Disentangle" style="width:530px;height:650px;margin-left:75px;background-color: white;border-radius: 8px;margin-top:80px">
               <div class="header2" style="width:94%;margin-left: 3%;">
                   <p style="font-size: 18px;font-weight: bold;">Refine Sketch</p>
               </div>
 
               <el-button @click="genSingleObject()" style = "margin-top: 1%;margin-bottom: 1%; margin-left: 10px;">
                       Generate
               </el-button>
               ...
               <el-button @click="addDragMask" style = "margin-top: 1%;margin-bottom: 1%; margin-left: 110px;">
                 Show
               </el-button>
               <el-button @click="updateDragMask" style = "margin-top: 1%;margin-bottom: 1%;">
                 Save
               </el-button>
               <el-button @click="cleanMask()" style = "margin-top: 1%;margin-bottom: 1%;">
                 Clean
               </el-button>
 ...
 import { postSketch, postGallery, postInference,postClean, postCleanMask, postGenSingle,postAnchorSingle,postResult, postMaskUpdate } from "../service/module/dataService";
